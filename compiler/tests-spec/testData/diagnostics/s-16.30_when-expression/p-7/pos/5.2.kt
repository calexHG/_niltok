...
fun case_14(value: Any, value1: _Class, value2: _Class?, value3: Int) {
    ...
    when (value) {
        _fun(), __fun_1()(), value1.fun_2(value3) -> {}
...
fun case_24(value: Nothing?): String = when (<!DEBUG_INFO_CONSTANT!>value<!>) {
...
/*
 ...
 ISSUES: KT-25948
 */
fun case_25(value: Boolean) = when (<!DEBUG_INFO_CONSTANT!>value<!>) {
    true -> {}
